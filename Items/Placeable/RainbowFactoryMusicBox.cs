...
{
	public class RainbowFactoryMusicBox : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Music Box (Rainbow Factory)");
		}
        ...
        public override void SetDefaults()
		{
			...
			item.createTile = ModContent.TileType<Tiles.RainbowFactoryMusicBox>();
			item.width = 24;
			item.height = 24;
